...
function iconMega1() {
  ...
  var test1 = test.substring(32);
  document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + "m" + '.' + test1;
...
function iconGigan1() {
  ...
  var test1 = test.substring(32);
   document.getElementById("pic1").src = "../sprites/" + alolares3;
   document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + "_1" + '.' + test1;
...
function iconGalar1() {
  ...
  var galarres4 = galarpic3.substring(38,40);
  var galarres3 = galarres1.replace(/.png|a.png/, "g.png");
  var test = document.getElementById("pic2").src;
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + galarres3;
  document.getElementById("pic3").src = "../sprites/fused/" + galarres4 + "g" + '.' + test1;
...
function iconMega1X() {
  ...
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + "mx" + "." + test1;
  document.getElementById("megaoui").innerHTML = "Mega ";
...
function iconMega1Y() {
  ...
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + "my" + "." + test1;
  document.getElementById("megaoui").innerHTML = "Mega ";
...
function icon1AltGalarForm2(){
  ...
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + 'g_2' + "." + test1;
  document.getElementById("select1").disabled = true;
  document.getElementById("select2").disabled = true;
  document.getElementById("icon1").style.display = "block";
  document.getElementById("icon1-altform").style.display = "none";
...
function icon1AltForm3(){
  ...
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + '_3' + '.' + test1;
  document.getElementById("select1").disabled = true;
  document.getElementById("select2").disabled = true;
  document.getElementById("icon1").style.display = "block";
  document.getElementById("icon1-altform").style.display = "none";
...
function icon1AltForm4(){
  ...
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + "_4" + "." + test1;
  document.getElementById("select1").disabled = true;
  document.getElementById("select2").disabled = true;
  document.getElementById("icon1").style.display = "block";
  document.getElementById("icon1-altform").style.display = "none";
...
function icon1AltForm5(){
  ...
  var test1 = test.substring(32);
    document.getElementById("pic1").src = "../sprites/" + alolares3;
  document.getElementById("pic3").src = "../sprites/fused/" + alolares4 + '_5' + '.' + test1;
  document.getElementById("select1").disabled = true;
  document.getElementById("select2").disabled = true;
  document.getElementById("icon1").style.display = "block";
  document.getElementById("icon1-altform").style.display = "none";
...
function iconNormal2() {
  ...
  var test3 = document.getElementById("pic2").src;
    var test5 = document.getElementById("pic3").src;
    var res5 = test3.substring(32);
    var res9 = test5.substring(38,40);
    var res7 = res5.replace(/a.png|m.png|g.png|mx.png|my.png|_1.png|_2.png|g_2.png|_3.png|_4.png|_5.png/, ".png");
