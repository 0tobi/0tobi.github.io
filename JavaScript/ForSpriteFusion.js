...
function iconAlola1() {
  ...
  var alolares1 = alolapic2.substring(65);
  var test1 = test.substring(65);
  var alolares4 = alolapic3.substring(71);
...
function iconNormal1() {
  ...
  var test3 = document.getElementById("pic1").src;
    ...
    var res5 = test3.substring(65);
    var res9 = test5.substring(71);
...
function iconGalar1() {
  ...
  var galarres1 = galarpic2.substring(65);
  var galarres4 = galarpic3.substring(71);
